...
try:
    ...
    for i, url_url_id in enumerate(url_list):
        ...
        try:
            ...
            date_volume_issue = current_soup.find('div',class_="njq").text
            pattern = r'(\d{1,2}) ([A-Za-z]+) (\d{4}), Volume (\d+) Issue (\d+)'

            # Search for the pattern in the text
            match = re.search(pattern, date_volume_issue)
            ...
            for article in articles:
                ...
                Pdf_link = f"https://www.chinagp.net/CN/PDF/{DOI}?"
